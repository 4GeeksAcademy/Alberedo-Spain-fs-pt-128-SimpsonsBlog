        ...
        <>
            <div className="row container mx-auto m-5">
                ...
                <div className="row mt-3 justify-content-around">
                    {data.town && <div className="col-12 col-md-4 text-center"><h3>Town</h3>{data && data.town}</div>}
                    {data.use && <div className="col-12 col-md-4 text-center"><h3>Use</h3>{data && data.use}</div>}
                    {data.first_appearance_ep && <div className="col-12 col-md-4 text-center">
